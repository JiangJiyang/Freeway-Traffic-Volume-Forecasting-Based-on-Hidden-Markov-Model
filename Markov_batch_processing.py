...
class predict:
   def __init__(self,data,param0,param1,W0,W1,W,holiday):
...
dataset = READ.read_data(row_index = list(range(2,28)),col_index = list(range(2,62)))
...
for i in range(len(dataset)):
  ...
  while(1):
     if j == 0:
        ...
        break
     j += 1
  PREDICT = predict(data,param0,param1,W0,W1,W,holiday = 40)
